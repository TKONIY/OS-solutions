 ...
 * Compiler:  gcc7.5.0
 * 
 * 参考 https://blog.csdn.net/Wind__Chaser/article/details/88926639?utm_medium=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.nonecase&depth_1-utm_source=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.nonecase
 * 思考:
...
void leave()
{
    printf("waiting=%d a customer leaved\n", waiting);
}

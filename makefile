...
all : $(BUILD)3_10_fib_shm.out $(BUILD)3_6_fib.out $(BUILD)3_27_filecopy.out $(BUILD)3_11_shm_ds.out $(BUILD)4_9_prime.out $(BUILD)6_10_sleep_barber.out
...
$(BUILD)6_10_sleep_barber.out: $(SRC)6_10_sleep_barber.c
	$(CC) $(STD) $(SRC)6_10_sleep_barber.c -o $(BUILD)6_10_sleep_barber.out -lm -lpthread
